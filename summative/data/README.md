...
`africa_graduate_first_income.csv` is the modelling table. It contains 1,655
recent Nigerian graduates with a reported first-employment income, 11 input
...
naira. Exact duplicate source submissions are removed before preparation.
This approximation preserves ordering but not exact income. The sample is
voluntary, self-reported, historical, and Nigeria-specific. It supports an
